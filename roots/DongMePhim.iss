...
begin
  ...
  begin
    ...
    begin
      ...
      if Exec(sUnInstallString, '/SILENT /NORESTART /_?="' + ExtractFilePath(sUnInstallString) + '"', '', SW_HIDE, ewWaitUntilTerminated, iResultCode) then
      begin
